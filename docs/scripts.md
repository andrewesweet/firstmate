...
| `fm-trace-span-lib.sh`   | Single owner of the default-off OTLP/HTTP span emitter: one silent bounded post per firstmate lifecycle event, gated on the task's recorded carrier and the frozen session decision |
