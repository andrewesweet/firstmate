...
It is also the one owner of the no-mistakes `--intent` contract those workers follow: the brief's firstmate-authored `## Published intent`, never its `## Captain's intent` subsection.
