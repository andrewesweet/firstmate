...
- Continuity monitor: one per session, 30-minute timeout, re-armed on its own expiry, on any handled `prompt.submit` that finds no live monitor, and from the branch's settlement.
