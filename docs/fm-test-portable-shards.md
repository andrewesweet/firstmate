...
The four `tests/fm-branch-claude-mod*.test.sh` and `tests/fm-branch-mod-bin.test.sh` hints are local measurements from 2026-09-16 doubled, pending their first green CI artifacts.
