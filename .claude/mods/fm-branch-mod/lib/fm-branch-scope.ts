...
export interface Scope {
   ...
   *  row, comma-joined. Stamped onto shadow records and onto the outcome
   *  row the branch reports for this wake, so retrospective scorers join
   *  by identity instead of agent-supplied wake text. */
