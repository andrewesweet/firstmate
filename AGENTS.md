...
data/                personal fleet records; LOCAL, gitignored as a whole
  ...
  dispatch-spawns.jsonl  append-only actually-dispatched profile log for the offline dispatch replay scorer, one JSON line per successful ship or scout spawn (docs/configuration.md "Typed dispatch resolution")
